...
namespace fiskaltrust.Middleware.Interface.Client.Tests.IDESSCD.Wcf
{
    public class WcfIDESSCDTests : IDESSCDTests
    {
        ...
        protected override ifPOS.v1.de.IDESSCD CreateClient() => DeSscdFactory.CreateSscdAsync(new ClientOptions { Url = new Uri(_url), RetryPolicyOptions = _retryPolicyOptions }).Result;
