...
namespace fiskaltrust.Middleware.Interface.Client.Tests.IDESSCD.Wcf
{
    ...
    public class HttpIDESSCDTests : IDESSCDTests
    {
        ...
        protected override ifPOS.v1.de.IDESSCD CreateClient() => HttpMESSCDFactory.CreateSSCDAsync(new HttpPosClientOptions { Url = new Uri(_url), RetryPolicyOptions = _retryPolicyOptions }).Result;
